...
export const defaultPromptParts = {
  ...
  'Segmentation masks': [
    `Generate high-resolution, detailed segmentation masks for`,
    'all objects',
    `. The masks should precisely outline each object. Output a JSON list where each entry contains the 2D bounding box in "box_2d", the segmentation mask in "mask", and a descriptive text label in "label".`,
  ],
  '3D bounding boxes': [
